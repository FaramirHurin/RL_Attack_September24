...
def generate_customer_profiles_table(n_customers, random_state=0):
    ...
    for customer_id in range(n_customers):
        x_customer_id = np.random.uniform(0, max_xy)
        y_customer_id = np.random.uniform(0, max_xy)
    ...
    customer_profiles_table = pd.DataFrame(
        customer_id_properties, columns=["CUSTOMER_ID", "x_customer_id", "y_customer_id", "mean_amount", "std_amount", "mean_nb_tx_per_day"]
    )
...
def generate_dataset(n_customers=10000, n_terminals=1000000, nb_days=90, start_date="2018-04-01", r=5):
    ...
    # With Pandarallel
    transactions_df = (
        customer_profiles_table.groupby("CUSTOMER_ID")  # type: ignore
...
def main():
    ...
    # Store customer_profiles_table, terminal_profiles_table
    pk.dump(customer_profiles_table, open(DIR_OUTPUT + "customer_profiles_table.pkl", "wb"))
    pk.dump(terminal_profiles_table, open(DIR_OUTPUT + "terminal_profiles_table.pkl", "wb"))
