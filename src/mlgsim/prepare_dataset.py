...
def preprocess():
    ...
    customer_profiles_table["balance"] = (
        customer_profiles_table["mean_amount"] * customer_profiles_table["mean_nb_tx_per_day"] * 60
    ).round(2)
    ...
    customer_profiles_table.rename(
        columns={
            "CUSTOMER_ID": "id",
            "x_customer_id": "x",
            "y_customer_id": "y",
    ...
    terminal_profiles_table.rename(
        columns={
            "TERMINAL_ID": "id",
            "x_terminal_id": "x",
            "y_terminal_id": "y",
